...
func NewCommandStartE2EAdapterServer(out, errOut io.Writer, stopCh <-chan struct{}) *cobra.Command {
...
func (o E2EAdapterServerOptions) RunCustomMetricsAdapterServer(stopCh <-chan struct{}) error {
	config, err := o.Config()
	if err != nil {
		return err
	}
...
type E2EAdapterServerOptions struct {
