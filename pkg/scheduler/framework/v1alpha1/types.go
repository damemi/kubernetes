...
func NewPodInfo(pod *v1.Pod) (*PodInfo, error) {
	...
	preferredWeightedAffinityTerms, err := getWeightedAffinityTerms(pod, preferredAffinityTerms)
	if err != nil {
		return nil, err
	}
	preferredWeightedAntiAffinityTerms, err := getWeightedAffinityTerms(pod, preferredAntiAffinityTerms)
	if err != nil {
		return nil, err
	}
	return &PodInfo{
		...
		PreferredAffinityTerms:     preferredWeightedAffinityTerms,
		PreferredAntiAffinityTerms: preferredWeightedAntiAffinityTerms,
	}, nil
}
...
func (n *NodeInfo) AddPod(pod *v1.Pod) error {
