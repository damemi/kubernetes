...
func NewPodInfo(pod *v1.Pod) *PodInfo {
	...
	requiredAffinityTerms, podErr := getAffinityTerms(pod, schedutil.GetPodAffinityTerms(pod.Spec.Affinity))
	requiredAntiAffinityTerms, podErr := getAffinityTerms(pod, schedutil.GetPodAntiAffinityTerms(pod.Spec.Affinity))
	weightAffinityTerms, podErr := getWeightedAffinityTerms(pod, preferredAffinityTerms)
	weightedAntiAffinityTerms, podErr := getWeightedAffinityTerms(pod, preferredAntiAffinityTerms)

	return &PodInfo{
		Pod:                        pod,
		RequiredAffinityTerms:      requiredAffinityTerms,
		RequiredAntiAffinityTerms:  requiredAntiAffinityTerms,
		PreferredAffinityTerms:     weightAffinityTerms,
